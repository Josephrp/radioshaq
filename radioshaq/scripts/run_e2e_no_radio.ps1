...
#   pm2 start radioshaq-api --env test
#   pm2 start ecosystem.config.js --only radioshaq-e2e
...
$env:RADIOSHAQ_RADIO__ENABLED = "false"
$env:RADIOSHAQ_RADIO__AUDIO_INPUT_ENABLED = "false"
...
try { pm2 delete radioshaq-api 2>&1 | Out-Null } catch { }
Start-Sleep -Seconds 1

Write-Host "Starting radioshaq-api (test env, no radio), port $TestPort..."
...
pm2 stop radioshaq-api
Write-Host "PM2 radioshaq-api stopped."
exit $exitCode
