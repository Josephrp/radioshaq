#!/bin/bash
# Deploy RadioShaq Lambda functions (API handler, message handler)
...
RADIOSHAQ_ROOT="$(cd "${SCRIPT_DIR}/../../.." && pwd)"
...
# Build deployment package: radioshaq package + lambda handlers + dependencies
